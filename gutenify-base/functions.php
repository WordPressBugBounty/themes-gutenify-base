...
add_action( 'tgmpa_register', 'gutenify_base_register_required_plugins' );

/**
 * Register the required plugins for this theme.
 *
 * In this case, we register Gutenify Mega Menu.
 */
function gutenify_base_register_required_plugins() {
	/*
	...
	$plugins = array(
		array(
			'name'      => 'Gutenify Mega Menu',
			'slug'      => 'gutenify-mega-menu',
			'required'  => false,
		),
	);
	 ...
	 */
	$config = array(
		'id'           => 'gutenify-base',                 // Unique ID for hashing notices for multiple instances of TGMPA.
